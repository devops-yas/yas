...
class SampleDataServiceTest {
    ...
    @Test
    void shouldReturnSuccessMessageEvenWhenScriptsFail() {
        DataSource productDataSource = new ThrowingDataSource();
        DataSource mediaDataSource = new ThrowingDataSource();
